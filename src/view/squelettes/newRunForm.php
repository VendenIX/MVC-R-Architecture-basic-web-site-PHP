<form action="<?php echo $this->router->getRunSaveURL(); ?>" method="post">
            ...
            <select name="game" id="<?php echo RunBuilder::GAME_REF; ?>">
                <?php foreach(RunBuilder::GAME_LIST as $game): ?>
                    <option value="<?php echo $game; ?>" <?php if ($game == $this->content["dataForm"]["game"]) { echo "selected=\"true\"";} ?>> <?php echo $game; ?></option>
                <?php endforeach; ?>
            </select><br>
            ...
            <select id="mode" name="<?php echo RunBuilder::MODE_REF; ?>">
                <?php foreach(RunBuilder::MODE_LIST as $mode): ?>
                    <option value="<?php echo $mode; ?>" <?php if ($mode == $this->content["dataForm"]["mode"]) { echo "selected=\"true\"";} ?>> <?php echo $mode; ?></option> 
                <?php endforeach; ?>
            </select><br>
